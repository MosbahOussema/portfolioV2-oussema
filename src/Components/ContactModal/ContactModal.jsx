        ...
        <div className="contact-grid">
          <div className="contact-item" onClick={handleEmail}>
            ...
            <div className="contact-info">
              <h3>{t.contactModal.email}</h3>
            </div>
          </div>

          <div className="contact-item" onClick={handleLinkedIn}>
            <div className="contact-icon">
              <svg
                width="24"
                height="24"
          ...
          <div className="contact-item" onClick={handleWhatsApp}>
            ...
            <div className="contact-info">
              <h3>{t.contactModal.whatsapp}</h3>
            </div>
          </div>

          <div className="contact-item" onClick={handleGitHub}>
            <div className="contact-icon">
              <svg
                width="24"
                height="24"
